  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFF8F0] via-[#EAC7C7]/10 to-[#FFF8F0]">
      ...
      <header className="relative overflow-hidden">
        ...
        />
        {/* Decorative soft blur circles (keeps subtle on mobile) */}
...
<section className="bg-white rounded-2xl shadow-xl overflow-hidden">
  <div className="p-4 sm:p-6 md:p-8">
    ...
    {/* Removed top image — now clean text intro */}
    <p className="text-base sm:text-lg text-gray-700 leading-relaxed text-center max-w-2xl mx-auto mt-2">
      Welcome to LunaBloom. A sanctuary where relaxation meets self-care.
      Nestled in the heart of Accra, LunaBloom offers holistic spa experiences
      designed to help you feel refreshed, centered, and radiant.
    </p>
        ...
        {/* WHY CHOOSE US — stacked, image + list on mobile (image first) */}
        ...
        {/* FEATURED SERVICES — images with overlay titles (mobile friendly card sizes) */}
        ...
        {/* CTA — prominent and mobile-friendly */}
